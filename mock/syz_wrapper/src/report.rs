...
impl ReportConfig {
    pub fn check(&mut self) -> Result<(), String> {
        ...
        resolve_tool_path(&syz_dir, "syz-symbolize")?;
...
pub fn extract_report(
    ...
    let syz_symbolize_path = resolve_tool_path(&config.syz_dir, "syz-symbolize")
        .map_err(ReportError::SyzSymbolize)?;
    let mut syz_symbolize = Command::new(syz_symbolize_path);
    syz_symbolize
